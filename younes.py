...
class BureauDePoste:
    ...
    """
    def __init__(self, env, Nombre_Guichet, mu):
        self.env = env
...
def process(env, nombre_serveur, mu, lmbda):
    ...
    bureauDePoste = BureauDePoste(env, nombre_serveur,
                                      mu)  # mu pour calculer le temp de service de ce client
